...
function UpdateMenClothes(props) {
	...
	const getMenProduct = () => {
		Axios.get(`/api/menclothes/${product_id}`).then((res) => {
	...
	const onFormSubmit = (id) => {
		...
		const url = '/api/menclothes/updateMenClothes';
...
export default UpdateMenClothes;
